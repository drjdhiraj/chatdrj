...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "Done! Congratulations on your new bot. You will find it at t.me/drjdhirajbot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
6063629900:AAEef7YTd0E-jp_shTvSNqk_nH1l3yNCiYY
